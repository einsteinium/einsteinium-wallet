...
import com.einsteinium.wallet.R;
...
public class Constants
{
	...
	public static final String REPORT_EMAIL = "contact@einsteinium.org";
	...
	public static final String SOURCE_URL = "https://github.com/einsteinium/" + CoinDefinition.coinName.toLowerCase() + "-wallet";
	public static final String BINARY_URL = "http://code.google.com/p/bitcoin-wallet/downloads/list";
	public static final String CREDITS_BITCOINJ_URL = "https://github.com/einsteinium/" + CoinDefinition.coinName.toLowerCase() + "j";
	public static final String CREDITS_ZXING_URL = "http://code.google.com/p/zxing/";
    public static final String CREDITS_WEBSITE_URL = "http://www.einsteinium.org/";
    public static final String CREDITS_FORUM_URL = "http://forum.einsteinium.org/";
	public static final String CREDITS_ICON_URL = "https://bitcointalk.org/index.php?action=profile;u=2062";

	public static final String AUTHOR_TWITTER_URL = "https://twitter.com/#!/EinsteiniumCoin";
	public static final String AUTHOR_GOOGLEPLUS_URL = "https://profiles.google.com/Einsteinium";

	public static final String COMMUNITY_GOOGLEPLUS_URL = "https://plus.google.com/communities/";

	public static final String MARKET_APP_URL = "market://details?id=%s";
	public static final String WEBMARKET_APP_URL = "https://play.google.com/store/apps/details?id=%s";
	public static final String MARKET_PUBLISHER_URL = "market://search?q=pub:\"Einsteinium\"";
