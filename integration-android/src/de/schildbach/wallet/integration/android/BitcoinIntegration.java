...
public final class BitcoinIntegration
{
	...
	{
		final StringBuilder uri = new StringBuilder("einsteinium:");
		if (address != null)
			uri.append(address);
		if (amount != null)
	...
	{
		Toast.makeText(context, "No Einsteinium application found.\nPlease install Einsteinium Wallet.", Toast.LENGTH_LONG).show();
